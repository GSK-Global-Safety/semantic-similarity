 ...
 * 
 */
public class WuPalmerPerlMetric extends BaseSimilarityMetric {
	...
	public double similarity(String concept1, String concept2,
		...
		if (simInfo.getLcses().size() > 0) 
		{
			...
			//
			// Compute Wu-Palmer Similarity according to wup.pm
			//
			...
			double score = (2.0*lcsDepth) / (c1Depth + c2Depth + 1.0);
			return score;
		}
		return 0d;
	}

	public WuPalmerPerlMetric(ConceptSimilarityService simSvc) {
		super(simSvc);
	}
