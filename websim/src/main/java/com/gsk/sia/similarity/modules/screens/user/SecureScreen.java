package com.gsk.sia.similarity.modules.screens.user;
...
public class SecureScreen extends VelocitySecureScreen {
	...
	protected boolean isAuthorized(PipelineData pipelineData) throws Exception {
		...
		if (acl == null) {
			...
			isAuthorized = false;
		} else if (acl.hasRole("administrator") || acl.hasRole("editor") || acl.hasRole("rx_reviewer") || acl.hasRole("vx_reviewer") ) {
			isAuthorized = true;
		} else {
